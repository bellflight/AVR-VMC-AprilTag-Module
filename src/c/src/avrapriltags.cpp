...
json jsonify_tag(nvAprilTagsID_t detection) {
  ...
  j["rotation"] = {{detection.orientation[0], detection.orientation[3],
                   ...
                   {detection.orientation[1], detection.orientation[4],
                    detection.orientation[7]},
                   {detection.orientation[2], detection.orientation[5],
                    detection.orientation[8]}};
...
int main() {
  ...
  cv::VideoCapture capture(
      ...
      "height=720,format=NV12, framerate=15/1 ! nvvidconv ! "
